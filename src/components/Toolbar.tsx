...
export default function Toolbar({
  ...
  return (
    <div className="fixed left-4 right-4 bottom-6 md:left-6 md:right-auto md:top-6 md:bottom-auto z-50 animate-in fade-in slide-in-from-bottom-8 md:slide-in-from-right-8 duration-500">
      <div className="bg-black/60 md:bg-black/40 backdrop-blur-xl border border-white/10 p-3 md:p-4 rounded-full md:rounded-3xl shadow-2xl w-auto md:w-64 ring-1 ring-white/5">
        ...
        <div className="flex flex-row md:flex-col items-center md:items-stretch gap-2 md:gap-4 overflow-hidden no-scrollbar">
          <ToolButtons
            tool={settings.tool}
          ...
          {settings.tool === 'draw' && (
            <div className="flex flex-row md:flex-col items-center md:items-stretch gap-4 animate-in fade-in slide-in-from-right-4 md:slide-in-from-top-2 duration-300">
               <div className="w-px h-8 md:w-auto md:h-px bg-white/10 flex-shrink-0" />
               <LineWidthSlider
